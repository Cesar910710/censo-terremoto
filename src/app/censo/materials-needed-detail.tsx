...
export function MaterialsNeededDetailButton({
  beneficiaryName,
  materials,
}: {
      ...
      >
        <div className="flex flex-col gap-3 p-5 text-sm">
          <div className="flex flex-col gap-0.5">
            <p className="text-base font-medium">Materiales solicitados</p>
            <p className="text-zinc-600 dark:text-zinc-400">{beneficiaryName}</p>
          </div>
